...
/* initialize erl interface (once only) */
erl_init(NULL, 0);
...
// gcc -o fac -I/usr/lib64/erlang/lib/erl_interface-3.10.2.1/include -L/usr/lib64/erlang/lib/erl_interface-3.10.2.1/lib fac.c -lerl_interface -lei

// gcc -o fac -I/usr/lib64/erlang/lib/erl_interface-3.10.2.1/include -L/usr/lib64/erlang/lib/erl_interface-3.10.2.1/lib fac.c -lerl_interface -lei -pthread
